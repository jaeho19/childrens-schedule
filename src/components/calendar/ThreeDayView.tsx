...
import { getThreeDays, toDateString, GRID_HEIGHT, getHourLabels } from "@/lib/date-utils";
...
export function ThreeDayView({ events, categories, members, onEventClick, onSlotDoubleClick }: ThreeDayViewProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* 요일 헤더 */}
      <div className="threeday-grid-row border-b border-gray-200 bg-white sticky top-0 z-10">
        <div />
        {days.map((day) => {
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="relative" style={{ height: `${GRID_HEIGHT}px` }}>
          ...
          <div className="threeday-grid-row h-full">
            {/* 시간 라벨 열 */}
